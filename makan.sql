...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 14 Bulan Mei 2019 pada 17.23
...
(82, 6, 1, 3, 30000, 1, '2019-05-14'),
(83, 6, 6, 11, 110000, 1, '2019-05-14'),
(85, 6, 2, 4, 60000, 1, '2019-05-14'),
(86, 6, 1, 2, 20000, 1, '2019-05-14'),
(88, 6, 1, 5, 50000, 1, '2019-05-14');
...
(18, 6, 'ewfwef', 321111, 3, 30000, 'BRI', 'Menunggu Pembayaran', '2019-05-14'),
(19, 6, 'fgdg', 556, 18, 200000, 'BRI', 'Menunggu Pembayaran', '2019-05-14'),
(20, 6, 'lmlsls', 321111, 20, 220000, 'BRI', 'Menunggu Pembayaran', '2019-05-14'),
(21, 6, 'lahat', 31419, 25, 270000, 'Mandiri', 'Menunggu Pembayaran', '2019-05-14');
...
(6, 'aqbil fattaqqoh', 'aqbil', 'indratiarasaputra414@gmail.com', '12345', 989987);
...
--
ALTER TABLE `keranjang`
  MODIFY `id_keranjang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=89;
